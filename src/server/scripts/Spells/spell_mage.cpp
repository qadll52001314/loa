...
// 81356 - Magic Disciple (Mage Specialization)
enum MagicDiscipleSpells
{
    SPELL_MAGIC_MASTERY_FIRE    = 81358,
    SPELL_MAGIC_MASTERY_FROST   = 81359,
    SPELL_MAGIC_MASTERY_ARCANE  = 81357
};

class spell_mage_magic_disciple : public SpellScriptLoader
{
public:
    spell_mage_magic_disciple() : SpellScriptLoader("spell_mage_magic_disciple") {}

    class spell_mage_magic_disciple_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_mage_magic_disciple_AuraScript);
        ...
        void Register() override
        {
            OnEffectProc += AuraEffectProcFn(spell_mage_magic_disciple_AuraScript::OnTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_mage_magic_disciple_AuraScript();
    }
};
