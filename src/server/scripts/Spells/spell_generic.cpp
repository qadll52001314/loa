...
class spell_gen_vehicle_scaling : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_vehicle_scaling_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_gen_vehicle_scaling_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_HEALING_TAKEN_PCT);
...
#define SPELL_WOUND_OF_WAR_TRIGGER 81384

// 81383 - Wound of War
class spell_gen_wound_of_war_proc : public SpellScriptLoader
{
public:
    spell_gen_wound_of_war_proc() : SpellScriptLoader("spell_gen_wound_of_war_proc") {}

    class spell_gen_wound_of_war_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_gen_wound_of_war_proc_AuraScript);

        void OnTrigger(AuraEffect const* aurEff, ProcEventInfo& procInfo)
        {
            Unit* attacker = procInfo.GetActionTarget();
            Unit* victim = procInfo.GetProcTarget();

            if (!attacker || !victim || attacker == victim || !attacker->IsPlayer() || !victim->IsPlayer())
                return;

            float chance = procInfo.GetDamageInfo()->GetDamage() / victim->GetMaxHealth() * 100;

            if (frand(0, 100.0f) > chance)
                attacker->CastSpell(victim, SPELL_WOUND_OF_WAR_TRIGGER, true);
        }

        void Register() override
        {
            AfterEffectProc += AuraEffectProcFn(spell_gen_wound_of_war_proc_AuraScript::OnTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_gen_wound_of_war_proc_AuraScript();
    }
};

// 81384 - Wound of War Periodic Dummy
class spell_gen_wound_of_war : public SpellScriptLoader
{
public:
    spell_gen_wound_of_war() : SpellScriptLoader("spell_gen_wound_of_war") {}

    class spell_gen_wound_of_war_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_gen_wound_of_war_AuraScript);
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_gen_wound_of_war_AuraScript::HandlePeriodic, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_gen_wound_of_war_AuraScript();
    }
};

// 81414 - t1-1 damage proc
class spell_spec_tier1_1_damage_proc : public SpellScriptLoader
{
public:
    spell_spec_tier1_1_damage_proc() : SpellScriptLoader("spell_spec_tier1_1_damage_proc") { }
...
public:
    ...
    class spell_spec_tier1_1_heal_proc_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            ...
            OnEffectProc += AuraEffectProcFn(spell_spec_tier1_1_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };
...
public:
    ...
    class spell_spec_tier1_2_heal_proc_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            ...
            OnEffectProc += AuraEffectProcFn(spell_spec_tier1_2_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };
...
{
public:
    spell_spec_tier1_6_spell_proc() : SpellScriptLoader("spell_spec_tier1_6_spell_proc") {}

    class spell_spec_tier1_6_spell_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier1_6_spell_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier1_6_spell_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier1_6_spell_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };
...
// 81426 t2-3 attack proc
class spell_spec_tier2_3_attack_proc : public SpellScriptLoader
{
public:
    spell_spec_tier2_3_attack_proc() : SpellScriptLoader("spell_spec_tier2_3_attack_proc") {}

    class spell_spec_tier2_3_attack_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier2_3_attack_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier2_3_attack_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier2_3_attack_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier2_3_attack_proc_AuraScript();
    }
};

// 81580 t2-3 spell proc
class spell_spec_tier2_3_spell_proc : public SpellScriptLoader
{
public:
    spell_spec_tier2_3_spell_proc() : SpellScriptLoader("spell_spec_tier2_3_spell_proc") {}

    class spell_spec_tier2_3_spell_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier2_3_spell_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier2_3_spell_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier2_3_spell_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier2_3_spell_proc_AuraScript();
    }
};

// 81431 t2-8 periodic proc
class spell_spec_tier2_8_periodic_proc : public SpellScriptLoader
{
public:
    spell_spec_tier2_8_periodic_proc() : SpellScriptLoader("spell_spec_tier2_8_periodic_proc") {}

    class spell_spec_tier2_8_periodic_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier2_8_periodic_proc_AuraScript);
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_spec_tier2_8_periodic_proc_AuraScript::HandlePeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier2_8_periodic_proc_AuraScript();
    }
};
...
{
public:
    spell_spec_tier3_1_proc() : SpellScriptLoader("spell_spec_tier3_1_proc") {}

    class spell_spec_tier3_1_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_1_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_1_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_1_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_1_proc_AuraScript();
    }
};

// 81435 - spec t3-2 damage
class spell_spec_tier3_2_damage_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_2_damage_proc() : SpellScriptLoader("spell_spec_tier3_2_damage_proc") {}

    class spell_spec_tier3_2_damage_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_2_damage_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_2_damage_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_2_damage_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_2_damage_proc_AuraScript();
    }
};

// 81592 - spec t3-2 heal
class spell_spec_tier3_2_heal_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_2_heal_proc() : SpellScriptLoader("spell_spec_tier3_2_heal_proc") {}

    class spell_spec_tier3_2_heal_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_2_heal_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_2_heal_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_2_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_2_heal_proc_AuraScript();
    }
};

// 81439 - spec t3-6
class spell_spec_tier3_6_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_6_proc() : SpellScriptLoader("spell_spec_tier3_6_proc") {}

    class spell_spec_tier3_6_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_6_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_6_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_6_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_6_proc_AuraScript();
    }
};

// 81440 - spec t3-7
class spell_spec_tier3_7_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_7_proc() : SpellScriptLoader("spell_spec_tier3_7_proc") {}

    class spell_spec_tier3_7_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_7_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_7_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_7_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_7_proc_AuraScript();
    }
};

// 81441 - spec t3-8 damage proc
class spell_spec_tier3_8_damage_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_8_damage_proc() : SpellScriptLoader("spell_spec_tier3_8_damage_proc") {}

    class spell_spec_tier3_8_damage_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_8_damage_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_8_damage_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_8_damage_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_8_damage_proc_AuraScript();
    }
};

// 81599 - spec t3-8 heal proc
class spell_spec_tier3_8_heal_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_8_heal_proc() : SpellScriptLoader("spell_spec_tier3_8_heal_proc") {}

    class spell_spec_tier3_8_heal_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_8_heal_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_8_heal_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_8_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };
...
// 81443 - spec t3-10 damage proc
class spell_spec_tier3_10_damage_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_10_damage_proc() : SpellScriptLoader("spell_spec_tier3_10_damage_proc") {}

    class spell_spec_tier3_10_damage_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_10_damage_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_10_damage_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_10_damage_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_10_damage_proc_AuraScript();
    }
};

// 81608 - spec t3-10 heal proc
class spell_spec_tier3_10_heal_proc : public SpellScriptLoader
{
public:
    spell_spec_tier3_10_heal_proc() : SpellScriptLoader("spell_spec_tier3_10_heal_proc") {}

    class spell_spec_tier3_10_heal_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier3_10_heal_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier3_10_heal_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier3_10_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier3_10_heal_proc_AuraScript();
    }
};

// 81444 - spec t4-1 proc
class spell_spec_tier4_1_proc : public SpellScriptLoader
{
public:
    spell_spec_tier4_1_proc() : SpellScriptLoader("spell_spec_tier4_1_proc") {}

    class spell_spec_tier4_1_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier4_1_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier4_1_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier4_1_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier4_1_proc_AuraScript();
    }
};

// 81445 - spec t4-2 proc
class spell_spec_tier4_2_proc : public SpellScriptLoader
{
public:
    spell_spec_tier4_2_proc() : SpellScriptLoader("spell_spec_tier4_2_proc") {}

    class spell_spec_tier4_2_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier4_2_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier4_2_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier4_2_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier4_2_proc_AuraScript();
    }
};

// 81446 - spec t4-3 damage proc
class spell_spec_tier4_3_damage_proc : public SpellScriptLoader
{
public:
    spell_spec_tier4_3_damage_proc() : SpellScriptLoader("spell_spec_tier4_3_damage_proc") {}

    class spell_spec_tier4_3_damage_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier4_3_damage_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier4_3_damage_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier4_3_damage_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier4_3_damage_proc_AuraScript();
    }
};

// 81613 - spec t4-3 heal proc
class spell_spec_tier4_3_heal_proc : public SpellScriptLoader
{
public:
    spell_spec_tier4_3_heal_proc() : SpellScriptLoader("spell_spec_tier4_3_heal_proc") {}

    class spell_spec_tier4_3_heal_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier4_3_heal_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier4_3_heal_proc_AuraScript::HandleCheckProc);
            OnEffectProc += AuraEffectProcFn(spell_spec_tier4_3_heal_proc_AuraScript::HandleTrigger, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_spec_tier4_3_heal_proc_AuraScript();
    }
};

// 81450 t4-7 periodic proc
class spell_spec_tier4_7_periodic_proc : public SpellScriptLoader
{
public:
    spell_spec_tier4_7_periodic_proc() : SpellScriptLoader("spell_spec_tier4_7_periodic_proc") {}

    class spell_spec_tier4_7_periodic_proc_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_spec_tier4_7_periodic_proc_AuraScript);
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_spec_tier4_7_periodic_proc_AuraScript::HandleCheckProc);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_spec_tier4_7_periodic_proc_AuraScript::HandlePeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
