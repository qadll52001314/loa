...
enum SpellSchoolMask
{
    ...
    // 
    SPELL_SCHOOL_MASK_ELEMENTAL = (SPELL_SCHOOL_MASK_FIRE | SPELL_SCHOOL_MASK_FROST | SPELL_SCHOOL_MASK_NATURE),
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_POWER_DAMAGE                       = 165,
    SPELL_EFFECT_POWER_HEAL                         = 166,
    SPELL_EFFECT_COMPREHEND_SPELL                   = 167,
...
enum SkillType
{
    ...
    SKILL_EXPLORE_N_ADVENTURE      = 789,
    SKILL_STAT_STRENGTH            = 790,
    SKILL_STAT_AGILITY             = 791,
    SKILL_STAT_STAMINA             = 792,
    SKILL_STAT_INTELLECT           = 793,
    SKILL_STAT_SPIRIT              = 794,
    SKILL_CHAR_BENIFIT = 795,
    SKILL_SPEC_TIER1_1 = 796,
    SKILL_SPEC_TIER1_2 = 797,
    SKILL_SPEC_TIER1_3 = 798,
    SKILL_SPEC_TIER1_4 = 799,
    SKILL_SPEC_TIER1_5 = 800,
    SKILL_SPEC_TIER1_6 = 801,
    SKILL_SPEC_TIER1_7 = 802,
    SKILL_SPEC_TIER1_8 = 803,
    SKILL_SPEC_TIER1_9 = 804,
    SKILL_SPEC_TIER1_10 = 805,
    SKILL_SPEC_TIER2_1 = 806,
    SKILL_SPEC_TIER2_2 = 807,
    SKILL_SPEC_TIER2_3 = 808,
    SKILL_SPEC_TIER2_4 = 809,
    SKILL_SPEC_TIER2_5 = 810,
    SKILL_SPEC_TIER2_6 = 811,
    SKILL_SPEC_TIER2_7 = 812,
    SKILL_SPEC_TIER2_8 = 813,
    SKILL_SPEC_TIER2_9 = 814,
    SKILL_SPEC_TIER2_10 = 815,
    SKILL_SPEC_TIER3_1 = 816,
    SKILL_SPEC_TIER3_2 = 817,
    SKILL_SPEC_TIER3_3 = 818,
    SKILL_SPEC_TIER3_4 = 819,
    SKILL_SPEC_TIER3_5 = 820,
    SKILL_SPEC_TIER3_6 = 821,
    SKILL_SPEC_TIER3_7 = 822,
    SKILL_SPEC_TIER3_8 = 823,
    SKILL_SPEC_TIER3_9 = 824,
    SKILL_SPEC_TIER3_10 = 825,
    SKILL_SPEC_TIER4_1 = 826,
    SKILL_SPEC_TIER4_2 = 827,
    SKILL_SPEC_TIER4_3 = 828,
    SKILL_SPEC_TIER4_4 = 829,
    SKILL_SPEC_TIER4_5 = 830,
    SKILL_SPEC_TIER4_6 = 831,
    SKILL_SPEC_TIER4_7 = 832,
    SKILL_SPEC_TIER4_8 = 833,
    SKILL_SPEC_TIER4_9 = 834,
    SKILL_SPEC_TIER4_10 = 835,
    SKILL_SPEC_TIER5_1 = 836,
    SKILL_SPEC_TIER5_2 = 837,
    SKILL_SPEC_TIER5_3 = 838,
    SKILL_SPEC_TIER5_4 = 839,
    SKILL_SPEC_TIER5_5 = 840,
    SKILL_SPEC_TIER5_6 = 841,
    SKILL_SPEC_TIER5_7 = 842,
    SKILL_SPEC_TIER5_8 = 843,
    SKILL_SPEC_TIER5_9 = 844,
    SKILL_SPEC_TIER5_10 = 845
};

enum SpecializationSpells
{
    SPEC_SPELL_TIER1_1 = 81935,
    SPEC_SPELL_TIER1_2 = 81936,
    SPEC_SPELL_TIER1_3 = 81937,
    SPEC_SPELL_TIER1_4 = 81938,
    SPEC_SPELL_TIER1_5 = 81939,
    SPEC_SPELL_TIER1_6 = 81940,
    SPEC_SPELL_TIER1_7 = 81941,
    SPEC_SPELL_TIER1_8 = 81942,
    SPEC_SPELL_TIER1_9 = 81943,
    SPEC_SPELL_TIER1_10 = 81944,
    SPEC_SPELL_TIER2_1 = 81945,
    SPEC_SPELL_TIER2_2 = 81946,
    SPEC_SPELL_TIER2_3 = 81947,
    SPEC_SPELL_TIER2_4 = 81948,
    SPEC_SPELL_TIER2_5 = 81949,
    SPEC_SPELL_TIER2_6 = 81950,
    SPEC_SPELL_TIER2_7 = 81951,
    SPEC_SPELL_TIER2_8 = 81952,
    SPEC_SPELL_TIER2_9 = 81953,
    SPEC_SPELL_TIER2_10 = 81954,
    SPEC_SPELL_TIER3_1 = 81955,
    SPEC_SPELL_TIER3_2 = 81956,
    SPEC_SPELL_TIER3_3 = 81957,
    SPEC_SPELL_TIER3_4 = 81958,
    SPEC_SPELL_TIER3_5 = 81959,
    SPEC_SPELL_TIER3_6 = 81960,
    SPEC_SPELL_TIER3_7 = 81961,
    SPEC_SPELL_TIER3_8 = 81962,
    SPEC_SPELL_TIER3_9 = 81963,
    SPEC_SPELL_TIER3_10 = 81964,
    SPEC_SPELL_TIER4_1 = 81965,
    SPEC_SPELL_TIER4_2 = 81966,
    SPEC_SPELL_TIER4_3 = 81967,
    SPEC_SPELL_TIER4_4 = 81968,
    SPEC_SPELL_TIER4_5 = 81969,
    SPEC_SPELL_TIER4_6 = 81970,
    SPEC_SPELL_TIER4_7 = 81971,
    SPEC_SPELL_TIER4_8 = 81972,
    SPEC_SPELL_TIER4_9 = 81973,
    SPEC_SPELL_TIER4_10 = 81974,
    SPEC_SPELL_TIER5_1 = 81975,
    SPEC_SPELL_TIER5_2 = 81976,
    SPEC_SPELL_TIER5_3 = 81977,
    SPEC_SPELL_TIER5_4 = 81978,
    SPEC_SPELL_TIER5_5 = 81979,
    SPEC_SPELL_TIER5_6 = 81980,
    SPEC_SPELL_TIER5_7 = 81981,
    SPEC_SPELL_TIER5_8 = 81982,
    SPEC_SPELL_TIER5_9 = 81983,
    SPEC_SPELL_TIER5_10 = 81984,
};

enum TalentSpecializationSpells
{
    TS_ROGUE_ASSASSINATION = 82027,
    TS_ROGUE_COMBAT = 82028,
    TS_ROGUE_SUBTITY = 82029,
    TS_ROGUE_GENERAL = 82032,
    TS_SHAMAN_ELEMENTAL = 82073,
    TS_SHAMAN_ENHANCEMENT = 82074,
    TS_SHAMAN_RESTORATION = 82075,
    TS_SHAMAN_GENERAL = 82076
};

#define MAX_SKILL_TYPE               846
...
enum SkillCategory
{
    SKILL_CATEGORY_SPECIFICATION = 1,
