...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS]=
{
    ...
    &AuraEffect::HandleNoImmediateEffect,                         //318 SPELL_AURA_DEATH_ESCAPE
    &AuraEffect::HandleNoImmediateEffect,                         //319 SPELL_AURA_PERIODIC_POWER_DAMAGE
    &AuraEffect::HandleNoImmediateEffect,                         //320 SPELL_AURA_POWER_SCHOOL_ABSORB
    &AuraEffect::HandleNoImmediateEffect,                         //321 SPELL_AURA_PERIODIC_POWER_HEAL
    &AuraEffect::HandleNoImmediateEffect,                         //322 SPELL_AURA_PERIODIC_POWER_LEECH
    &AuraEffect::HandleNoImmediateEffect,                         //323 SPELL_AURA_MOD_REST_XP_GENERATE_RATE
    &AuraEffect::HandleNoImmediateEffect,                         //324 SPELL_AURA_MOD_DUALWIELD_MELEE_HASTE
    &AuraEffect::HandleNoImmediateEffect,                         //325 SPELL_AURA_DRAIN_HEALTH_FROM_MECHANIC_DAMAGE
    &AuraEffect::HandleNoImmediateEffect,                         //326 SPELL_AURA_PREVENT_POWER_LOSS_AT_PCT_NOT_STACK
    &AuraEffect::HandleNoImmediateEffect,                         //327 SPELL_AURA_SHARE_HEAL_FROM_PARTY_NOT_STACK
    &AuraEffect::HandleNoImmediateEffect,                         //328 SPELL_ARUA_MOD_CRIT_DAMAGE_MELEE
    &AuraEffect::HandleNoImmediateEffect,                         //329 SPELL_AURA_MOD_CRIT_DAMAGE_RANGED
    &AuraEffect::HandleNoImmediateEffect,                         //330 SPELL_AURA_MOD_CRIT_DAMAGE_SPELL
    &AuraEffect::HandleNoImmediateEffect,                         //331 SPELL_AURA_REDUCE_MASS_DAMAGE
    &AuraEffect::HandleNoImmediateEffect,                         //332 SPELL_AURA_MOD_NETHER_REALM
    &AuraEffect::HandleNoImmediateEffect,                         //333 SPELL_AURA_MOD_MELEE_CRIT_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //334 SPELL_AURA_MOD_RANGED_CRIT_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //335 SPELL_AURA_MOD_SPELL_CRIT_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //336 SPELL_AURA_MOD_MELEE_CRIT_DAMEGE_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //337 SPELL_AURA_MOD_RANGED_CRIT_DAMEGE_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //338 SPELL_AURA_MOD_SPELL_CRIT_DAMEGE_CHANCE_FROM_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //339 SPELL_AURA_MOD_SINGLE_PHASE
    &AuraEffect::HandleNoImmediateEffect,                         //340 SPELL_AURA_MOD_DAMAGE_AGAINST_CASTER
    &AuraEffect::HandleNoImmediateEffect,                         //341 SPELL_AURA_MOD_SALVAGE_RATE
};
