...
enum AuraType
{
    ...
    SPELL_AURA_MOD_DAMAGE_DONE_CREATURE_PCT_OBS             = 317,
    SPELL_AURA_DEATH_ESCAPE                                 = 318,
    SPELL_AURA_PERIODIC_POWER_DAMAGE                        = 319,  // NYI
    SPELL_AURA_POWER_SCHOOL_ABSORB                          = 320,  // NYI
    SPELL_AURA_PERIODIC_POWER_HEAL                          = 321,  // NYI
    SPELL_AURA_PERIODIC_POWER_LEECH                         = 322,  // NYI
    SPELL_AURA_MOD_REST_XP_GENERATE_RATE                    = 323,  // NYI
    SPELL_AURA_MOD_DUALWIELD_MELEE_HASTE                    = 324,  // NYI
    SPELL_AURA_DRAIN_HEALTH_FROM_MECHANIC_DAMAGE            = 325,  // NYI
    SPELL_AURA_PREVENT_POWER_LOSS_AT_PCT_NOT_STACK          = 326,  // NYI
    SPELL_AURA_SHARE_HEAL_FROM_PARTY_NOT_STACK              = 327,  // NYI
    SPELL_AURA_MOD_CRIT_DAMAGE_MELEE                        = 328,  // NYI
    SPELL_AURA_MOD_CRIT_DAMAGE_RANGED                       = 329,  // NYI
    SPELL_AURA_MOD_CRIT_DAMAGE_SPELL                        = 330,  // NYI
    SPELL_AURA_REDUCE_MASS_DAMAGE                           = 331,  // NYI
    SPELL_AURA_MOD_NETHER_REALM                             = 332,  // NYI
    SPELL_AURA_MOD_MELEE_CRIT_CHANCE_FROM_CASTER            = 333,  // NYI
    SPELL_AURA_MOD_RANGED_CRIT_CHANCE_FROM_CASTER           = 334,  // NYI
    SPELL_AURA_MOD_SPELL_CRIT_CHANCE_FROM_CASTER            = 335,  // NYI
    SPELL_AURA_MOD_MELEE_CRIT_DAMEGE_CHANCE_FROM_CASTER     = 336,  // NYI
