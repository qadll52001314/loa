...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        void GetContactPoint(WorldObject const* obj, float &x, float &y, float &z, float distance2d = CONTACT_DISTANCE, bool chasePoint = false) const;
