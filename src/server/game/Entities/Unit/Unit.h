...
class Unit : public WorldObject
{
    ...
    public:
        bool IsRecovering() const { return m_Recovery != 0; }
        void SetRecovery(uint32 recover) { m_Recovery = m_Recovery > recover ? m_Recovery : recover; }
        void UpdateRecovery(uint32 diff) { m_Recovery = m_Recovery > diff ? m_Recovery - diff : 0; }
    ...
    public:
        ...
        uint16 GetMaxAttriSkillValueForLevel(Unit const* target = NULL) const;
