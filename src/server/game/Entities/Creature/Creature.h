...
typedef std::map<uint32, CreatureStrengthData> CreatureStrengthDataMap;
...
struct VendorItemData
{
    ...
    void AddItem(uint32 item, int32 maxcount, uint32 ptime, uint32 ExtendedCost, uint32 ReqCityRank)
    {
        m_items.push_back(new VendorItem(item, maxcount, ptime, ExtendedCost, ReqCityRank));
    }
