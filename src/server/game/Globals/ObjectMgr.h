...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        uint32 GetXPForSupremacyLevel(uint32 supremacyLevel) const;
        ...
        void AddVendorItem(uint32 entry, uint32 item, int32 maxcount, uint32 incrtime, uint32 extendedCost, uint32 reqCityRank, bool persist = true); // for event
        ...
        typedef std::unordered_map<uint32, std::string> ServerMessageContainer;
    public:
        std::string GetServerMessage(uint32 id, ...);
        bool LoadServerMesssages();
    ...
    private:
        ...
        PlayerXPperLevel _playerXPperSupremacyLevel;
        ...
        ServerMessageContainer _serverMessageStore;
};
