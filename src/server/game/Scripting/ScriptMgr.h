...
class ResourcePointScript : public ScriptObject
{
    protected:
        ResourcePointScript(const char* name);
    public:
        bool IsDatabaseBound() const final override { return true; }
        virtual ResourcePoint* GetResourcePoint() const = 0;
};

class CapitalCityScript : public ScriptObject
{
    protected:
        CapitalCityScript(const char* name);
    public:
        bool IsDatabaseBound() const final override { return true; }
        virtual CapitalCity* GetCapitalCity() const = 0;
};
...
class ScriptMgr
{
    ...
    public: /* Scheduled scripts */
        ...
        ResourcePoint* CreateResourcePoint(uint32 scriptId);
        CapitalCity* CreateCapitalCity(uint32 scriptId);
