...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_REP_CHECKED_SINGLE_TIME_GOSSIP,
    CHAR_SEL_CHECKED_SINGLE_TIME_GOSSIP,

    CHAR_REP_RESOURCE_POINT,
    CHAR_REP_CAPITAL_CITY,

    CHAR_UPD_WAR_SCHOOL,
    CHAR_REP_SUPREMACY_STATS,
    CHAR_SEL_SUPREMACY_STATS,

    CHAR_UPD_CAPITAL_CITY_RESEARCH_STATE,

    CHAR_SEL_MEMORY,
    CHAR_REP_MEMORY,
    CHAR_UPD_MEMORY_CODE,
    CHAR_REP_MEMORY_CODE,

    CHAR_SEL_LEARNED_SPELL,
    CHAR_REP_LEARNED_SPELL,
    CHAR_DEL_LEARNED_SPELL,

    CHAR_SEL_LEARNED_TALENT,
    CHAR_REP_LEARNED_TALENT,
    CHAR_DEL_LEARNED_TALENT,
